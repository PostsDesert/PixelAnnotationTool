...
Name2Labels defaultLabels() {
	...
	labels["unlabeled"           ] = LabelInfo("eraser"           , "void"         ,  00, 0, QColor(  0,  0,  0));
	labels["background"               ] = LabelInfo("background"               , "void"         ,  35, 0, QColor(0,0,0));
	labels["person"         	 ] = LabelInfo("person"         	 , "person"       ,  01, 1, QColor(  192,  128,  128));
